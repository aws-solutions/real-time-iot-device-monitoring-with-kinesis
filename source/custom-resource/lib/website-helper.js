...
let s3 = new AWS.S3();
const fs = require('fs');
const _downloadKey = 'real-time-iot-device-monitoring-with-kinesis/latest/web-site-manifest.json';
...
let websiteHelper = (function() {
    ...
    websiteHelper.prototype.deployWebsite = function(sourceS3Bucket, sourceS3prefix, websiteBucket, cb) {
